      ...
      <div className='container'>
        <div className='nav'>
          ...
          <div className={`nav__main ${open ? "nav__mobile" : ""}`}>
            ...
            <ul className='nav__main--icons'>
              {iconsData.map((item, id) => (
                <li key={id}>
                  <a href={`https://www.${item}.com`} target="_blank" rel="noreferrer">
          ...
          <div className='nav__menu' onClick={() => setOpen(!open)}>
            <img src="data:image/png;base64," alt="Menu Icon" />
            </div>
        </div>
      </div>
    </div>
